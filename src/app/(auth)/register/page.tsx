      ...
      <div className="relative max-w-lg w-full">
        ...
        <div className="relative glass-panel rounded-3xl p-8 sm:p-10 border border-white/10 shadow-2xl space-y-6">
          <div className="text-center">
            ...
            <h2 className="text-2xl sm:text-3xl font-heading font-black text-white">Crear Cuenta en FALKO</h2>
          ...
          {error && (
            <div className="bg-rose-950/60 border border-rose-800/80 text-rose-300 text-xs p-3.5 rounded-xl">
              {error}
            </div>
          )}
